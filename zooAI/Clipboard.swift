...
class Clipboard {
  ...
  func copy(_ item: HistoryItem, removeFormatting: Bool = false) {
    ...
    pasteboard.setString("", forType: .fromZooAI)
  ...
  func paste() {
    ...
    DispatchQueue.main.async {
      ...
      // See https://github.com/p0deje/ZooAI/issues/482 for details.
  ...
  func checkForChangesInPasteboard() {
    ...
    // See https://github.com/p0deje/ZooAI/issues/241.
    ...
    // - https://github.com/p0deje/ZooAI/issues/78
    // - https://github.com/p0deje/ZooAI/issues/472
