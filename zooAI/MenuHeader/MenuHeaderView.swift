...
class MenuHeaderView: NSView, NSSearchFieldDelegate {
  ...
  private func processSingleCharacter(_ chars: String?) -> Bool {
    ...
    // Sometimes even though we attempt to activate ZooAI,
    ...
    // See https://github.com/p0deje/ZooAI/issues/473.
  ...
  private func focusQueryField() {
    ...
    // See https://github.com/p0deje/ZooAI/issues/476 for details.
