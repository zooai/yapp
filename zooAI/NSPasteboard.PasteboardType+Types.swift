...
extension NSPasteboard.PasteboardType {
  ...
  // https://github.com/p0deje/ZooAI/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from ZooAI.
  static let fromZooAI = NSPasteboard.PasteboardType(rawValue: "org.p0deje.ZooAI")
}
